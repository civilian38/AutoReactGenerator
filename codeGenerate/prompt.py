...
file_list_init_message="아래 목록은 현재 프로젝트에 존재하는 모든 파일의 목록, 그들에 대한 간략한 설명과 각 파일의 ID를 포함하고 있습니다. 제공된 파일 외에 추가로 내용을 알아야 하는 파일이 있다면 아래의 목록에서 확인할 수 있는 ID를 이용해 파일의 상세 내용을 요청하세요."
